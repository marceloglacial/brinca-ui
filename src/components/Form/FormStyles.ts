...
const styles: stylesType = {
    ...
    disabled: `form__disabled text-gray-400 border-gray-300 bg-gray-50 hover:cursor-not-allowed hover:text-gray-400 hover:border-gray-300 hover:bg-gray-50 after:border-gray-400`,
    ...
    text: `form__input rounded-2xl border-2 border-green-600 py-4 px-6 focus-visible:outline-green-600 focus-visible:outline-offset-2 focus-visible:outline-2`,
